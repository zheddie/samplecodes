...
namespace protobuf_myproto_2eproto {
extern PROTOBUF_INTERNAL_EXPORT_protobuf_myproto_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Person_PhoneNumber;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_myproto_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_Person;
}  // namespace protobuf_myproto_2eproto
namespace tutorial {
...
::google::protobuf::internal::SCCInfo<1> scc_info_Person =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsPerson}, {
      &protobuf_myproto_2eproto::scc_info_Person_PhoneNumber.base,}};
...
::google::protobuf::internal::SCCInfo<1> scc_info_AddressBook =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsAddressBook}, {
      &protobuf_myproto_2eproto::scc_info_Person.base,}};
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "myproto.proto", schemas, file_default_instances, TableStruct::offsets,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\rmyproto.proto\022\010tutorial\"\332\001\n\006Person\022\014\n\004"
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "myproto.proto", &protobuf_RegisterTypes);
}
...
const ::google::protobuf::EnumDescriptor* Person_PhoneType_descriptor() {
  protobuf_myproto_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_myproto_2eproto::file_level_enum_descriptors[0];
}
...
const ::google::protobuf::Descriptor* Person_PhoneNumber::descriptor() {
  ::protobuf_myproto_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_myproto_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const Person_PhoneNumber& Person_PhoneNumber::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_myproto_2eproto::scc_info_Person_PhoneNumber.base);
...
::google::protobuf::Metadata Person_PhoneNumber::GetMetadata() const {
  protobuf_myproto_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_myproto_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
const Person& Person::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_myproto_2eproto::scc_info_Person.base);
  return *internal_default_instance();
}
...
AddressBook::AddressBook()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  ::google::protobuf::internal::InitSCC(
      &protobuf_myproto_2eproto::scc_info_AddressBook.base);
  SharedCtor();
...
const AddressBook& AddressBook::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_myproto_2eproto::scc_info_AddressBook.base);
  return *internal_default_instance();
}
