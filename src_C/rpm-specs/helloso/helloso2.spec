...
%build
make -f makefile2 PREFIX=%{insdest} VERSION=2 all
make -f makefile2 PREFIX=%{buildroot}%{insdest} VERSION=2 install

%files -n helloso2
#%defattr(-, qsys, *none)
%{_libdir}/libhello.so.2.0.0
%{_libdir}/libworld.so.2.0.0
