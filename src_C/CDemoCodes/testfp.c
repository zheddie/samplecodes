...
*/
     ...
     *  called 'NativeHello'.
     */
    myClass = (*thEnv)->FindClass(thEnv, "Hello");
    if (! myClass) {
...
int main (int argc, char *argv[])
{
    ...
    fd1 = open("/home/wenlint/stdout.txt",
               O_CREAT|O_TRUNC|O_WRONLY, S_IWUSR|S_IWOTH);
    fd2 = open("/home/wenlint/stderr.txt",
               O_CREAT|O_TRUNC|O_WRONLY, S_IWUSR|S_IWOTH);
  ...
  /*  setca(NEW_ATTRIBUTES, _SRCA_EXCEPTION_MASK); //enable division 0*/
     ...
     */
    options[0].optionString="-Djava.class.path=/HOME/WENLINT/mysrc";
