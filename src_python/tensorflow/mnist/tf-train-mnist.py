...
def add(x, y):
  return tf.nn.bias_add(x, y, data_format=DATAFORMAT)
...
def conv2d(x, W):
  ...
  return tf.nn.conv2d(x, W, strides=[1, 1, 1, 1], padding='SAME', data_format=DATAFORMAT)


def max_pool_2x2(x):
  """max_pool_2x2 downsamples a feature map by 2X."""
  return tf.nn.max_pool(x, ksize=[1, 2, 2,1],
                        strides=[1, 2, 2,1], padding='SAME', data_format=DATAFORMAT)
